...
use pallet_token::{self as pallet_token,BalanceOf};
...
impl_runtime_apis! {
	impl pallet_token_rpc_runtime_api::TokenApi<Block,AccountId,Balance>  for Runtime{
		fn publish_token(account: AccountId,balance:Balance) -> AccountIndex{
		  Token::create_token(account,balance)
		}
  }
